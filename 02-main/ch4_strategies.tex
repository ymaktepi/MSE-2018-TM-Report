...
overhead are low, the score for the number of nodes is forced to be high.
\todo{add comments on error as well}
...
better visually compare the strategies on a per-class basis.
