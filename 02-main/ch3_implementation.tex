...
confirmed. The minimal value for latency is \(2\) because a minimum of two steps
are needed for nodes to both acknowledge the existance of a block and 
...
\begin{figure}[h]
  ...
  %\captionsetup{justification=centering}
    \caption{Metrics computation example \todo{comment}}
...
step.  \todo{remove - before cbc and casper}
